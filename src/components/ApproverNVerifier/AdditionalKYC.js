...
import { authPanValidation,gstValidation , ifscValidation,getBankId,bankAccountVerification} from "../../slices/kycSlice";
...
const AdditionalKYC = () => {
  ...
  const panLastName =
    BusinessDetailsStatus?.AuthPanValidation?.last_name === null
      ...
      const panNumber =  BusinessDetailsStatus?.GSTINValidation?.pan === null
      ? ""
      : BusinessDetailsStatus?.GSTINValidation?.pan;

      const legalName =  BusinessDetailsStatus?.GSTINValidation?.legalName === null
      ? ""
      : BusinessDetailsStatus?.GSTINValidation?.legalName;

      const state =  BusinessDetailsStatus?.GSTINValidation?.state === null
      ? ""
      : BusinessDetailsStatus?.GSTINValidation?.state;
      
      const registered_date =  BusinessDetailsStatus?.GSTINValidation?.register === null
      ? ""
      : BusinessDetailsStatus?.GSTINValidation?.register;
  
      const updated_date =  BusinessDetailsStatus?.GSTINValidation?.updated === null
      ? ""
    ...
    let bankAccountHolderName = `${AccfirstName} ${AcclastName}`;
      ...
      const accountValidity = allTabsValidate?.BankDetails?.accountValidation?.valid
...
{selectedDocType === "3" ? 
  ...
  ? accHolderName : ""}
            ...
            <div class="col-lg-4 font-weight-bold">
             Valid :  {panValidity === true ? "True" : panValidity === false ? "false" : "Not Found" }
            </div>
            <div class="col-lg-5">
...
{gstStatus === true && selectedDocType === "2" ?
  ...
  ? state : ""}
            ...
            <div class="col-lg-4 font-weight-bold">
             Reistered Date :  {registered_date
  ? registered_date : ""}
            </div>
          </div>
          <div class="row">
  ...
  ? updated_date : ""}
            ...
            <div class="col-lg-4 font-weight-bold">
             Valid :  {gstinValidity === true ? "True" : gstinValidity === false ? "false" : "Not Found"}
            </div>
          </div>
        </div>
...
{bankStatus === true && selectedDocType === "3" ?
          ...
          <div class="row">
            <div class="col-lg-4 font-weight-bold">
              Full Name :   {  bankAccountHolderName.length > 2
        ? bankAccountHolderName : ""}
          ...
          <div class="row">
            <div class="col-lg-4 font-weight-bold">
              Valid :    {accountValidity === true ? "True" : accountValidity === false ? "false" : "Not Found"}
            </div>
            {/* <div class="col-lg-5">
