  ...
  const aadharOtpVerification = async () => {
    ...
    try {
      const resp = await axiosInstanceJWT.post(API_URL.Aadhar_otp_verify, {
        referenceId: aadharOtpResp?.referenceId,
        otp: otpDigit,
      });
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  <strong>
                    {JSON.parse(aadharJsonResponse)?.masked_aadhar_number}
                  </strong>
                </p>

                <p className="card-text">
                  <strong>DOB:</strong> {JSON.parse(aadharJsonResponse)?.dob}
                  <br />
                  <strong>C/O:</strong>{" "}
                  {JSON.parse(aadharJsonResponse)?.father_name}
                  <br />
                  ...
                  {JSON.parse(aadharJsonResponse)?.pincode}
                  <br />
                  <strong>Status:</strong>{" "}
                  {JSON.parse(aadharJsonResponse)?.status === true && "True"}
                  <br />
                  <strong>Valid:</strong>{" "}
                  {JSON.parse(aadharJsonResponse)?.valid === true && "True"}
                  <br />
                </p>
                <p className="card-text">
