    ...
    try {
      const header = {
        headers: {
          ...
          Authorization:
            "Basic T1gwdU01S3l4eDdSekJ2anNjLjUwMGQ0MDE1M2EwMDI1OWM1NWM1YmUxYWM0YjgwNTZkOjE0ZjNhNTIzN2Y5NDFiZTk1MDRlMjAxNDRlYmRhZDUyNjEzZDI1YTI1OTBlNTQ2Zg==",
        },
      };
      const response = await axiosInstance.post(
        "https://api.attestr.com/api/v1/public/checkx/digilocker/eaadhaar",
        { auth: auth },
        header
      );
