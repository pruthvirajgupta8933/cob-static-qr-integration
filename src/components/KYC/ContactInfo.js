...
function ContactInfo(props) {
  ...
  const VerifyKycStatus = useSelector(
    (state) => state.kyc.kycVerificationForAllTabs.general_info_status
  );
  ...
  let KycVerifyStatusForPhone = useSelector(
    (state) => state.KycOtpSlice.OtpVerificationResponseForPhone.status
  );

  const KycVerifyStatusForEmail = useSelector(
    (state) => state.KycOtpSlice.OtpVerificationResponseForEmail.status
  );
          ...
          <Form>
            <div className="form-row">
              <div className="form-group col-md-4">
                ...
                {VerifyKycStatus ===
                "Verified" ? null : KycVerifyStatusForEmail === false ? (
                  role.merchant ?  <button
              ...
              <div className="form-group col-md-4">
                ...
                {VerifyKycStatus ===
                "Verified" ? null : KycVerifyStatusForPhone === false ? (
