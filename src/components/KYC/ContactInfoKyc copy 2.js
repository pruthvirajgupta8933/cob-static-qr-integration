...
function ContactInfoKyc(props) {
  ...
  const [updateIdProofVerifyStatus, setUpdateIdProofVerifyStatus] = useState({ current: "" });
      ...
      dispatch(aadhaarGetAadhaarSlice({ aadhaar_id: memoParamId }))
        .then((resp) => {
          if (
            ...
            setUpdateIdProofVerifyStatus({ current: 1 })
            ...
            setUpdateIdProofVerifyStatus({ current: "" })
