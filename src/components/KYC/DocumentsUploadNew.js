            ...
            <Form>
              <div className="form-row">
                <div class="col-sm-12 col-md-12 col-lg-12 mb-2">
                  ...
                  <span className="text-danger mb-4">* 5 Documents are mandatory required to upload : Aadhaar, Individual PAN, Business PAN, Cancelled Bank Cheque, Bank Statement</span>
                </div>
