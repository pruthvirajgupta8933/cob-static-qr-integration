        ...
        >
          <div className="modal-content kyc-modal_form ">
            <div class="modal-header p-1">
              ...
              <button type="button" onClick={() => redirect()} class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body p-0">
              ...
              <div className="card-group d-none">
                <div className="row">
                  <div className="col-lg-3 col-xsm-12 col-sm-12 col-md-12">
                    <div className="card">
                  ...
                  <div className="col-lg-9 col-xsm-12 col-sm-12 col-md-12">
                    <div className="card">
                      <div className="card-body">
