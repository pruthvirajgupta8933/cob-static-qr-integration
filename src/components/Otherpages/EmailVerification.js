...
const EmailVerification = () => {
  ...
  return (
    <div className="row d-flex justify-content-center">
      <div className="col-lg-6 col-md-6 col-sm-12 m-5 bg-light p-0">
        <div className="card text-center" >
          <div className="card-header headerBg" >
            <img src={sabpaisalogo} alt="logo" width={"150px"} height={"30px"} />
          </div>
          ...
          <div className="card-body">
            <p className="card-text" style={{ "fontSize": "24px" }}>
              <i className="fa fa-user" ariaHidden="true" style={{ "color": data ? "greenyellow" : "#000" }}></i>
              <i className="fa fa-check" ariaHidden="true" style={{ "color": data ? "greenyellow" : "#ff3030" }}></i>
            </p>
