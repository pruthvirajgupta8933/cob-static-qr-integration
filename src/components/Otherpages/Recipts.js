...
<div>
<div class="card" style={{position:'absolute',width:600, height:200,left:400}}>
  ...
  <div className="col-lg-6 mrg-btm- bgcolor">
                ...
                <button class="btn btn-success" onClick={() => onSubmit(input)} style={{ marginTop: '40px',marginLeft:200 }} >View</button>
  </div>
</div>
<br/>
<br/>
