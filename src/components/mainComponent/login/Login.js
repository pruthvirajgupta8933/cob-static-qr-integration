...
// Temporarily using a mock function that mimics the expected format
const encrypt = async (data, key, iv) => {
  // Simply base64 encode the data for testing
  return btoa(data);
};
...
const validationSchema = Yup.object().shape({
  ...
  reCaptcha: Yup.string().notRequired().nullable(), // Temporarily disabled for testing
});
