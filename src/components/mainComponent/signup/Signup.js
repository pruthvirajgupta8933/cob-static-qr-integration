  ...
  return (
    <React.Fragment>
      ...
      <div className={`container-fluid p-0`}>
        ...
        >
          <div
            className={`col-lg-5 text-white ${classes.background_image_left}`}
          >
                  ...
                  <div className="p-4 text-center">
                    ...
                    <div className={`my-5  ${classes.sp_font_24}`}>
                      ...
                      <p className={`m-0 text-white ${classes.sp_font_17}`}>
                        Quick onboarding | Easy Integration |
                      </p>
                      <p className={`m-0 text-white ${classes.sp_font_17}`}>
                        Feature filled Checkout
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="d-flex justify-content-around my-1 ">
                      <p className="mx-2 text-white">
                        <i class="mx-2 fa fa-light fa-envelope"></i>{" "}
                        support@sabpaisa.in
                      </p>
                      <p className="mx-2 text-white">
                        <i class="mx-2 fa fa-light fa-phone"></i> 011-41733223
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={`col ${classes.form_container}`}>
                        ...
                        <div className="bd-highlight text-center sp-font-12">
                          <div className="form-check">
                            ...
                            <lable>
                              ...
                              and hereby grant my consent for utilization and
                              processing of data accordingly
                            </lable>
                  ...
                  <div className="text-center my-5">
                    <p className={`${classes.sp_font_18} `}>
                      Already have an account with SabPaisa?{" "}
                      <Link
