...
function TransactionHistory() {
  ...
  const clientcode_rolebased = roles.bank ? "All" : roles.merchant ? clientMerchantDetailsList[0]?.clientCode : "";
        ...
        <div className="gx-main-content-wrapper">
          ...
          <section className="features8 cid-sg6XYTl25a flleft" id="features08-3-">
            <div className="container-fluid">
              <div className="row">
                {roles.merchant !== true ? <div className="col-lg-4 mrg-btm- bgcolor">
                ...
                {txnList.length > 0 ?
                  <nav aria-label="Page navigation example"  >
                    <ul className="pagination">
                      ...
                      {pages.length !== currentPage ? <a className="page-link" onClick={(nex) => { setCurrentPage((nex) => (nex === (pages.length > 9) ? nex : nex + 1)) }
