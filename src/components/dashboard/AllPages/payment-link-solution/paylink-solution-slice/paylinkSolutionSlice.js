...
export const paymentLinkSolutionSlice = createSlice({
    name: "paymentLinkSolutionSlice",
    initialState,
    reducers: {},
...
export const paymentLinkSolutionSliceReducer = paymentLinkSolutionSlice.reducer;
