                ...
                <div className="ant-row">
                  ...
                  <div className="ant-col chart_top_wrap ant-col-xs-24 ant-col-sm-24 ant-col-md-13 ant-col-lg-24 ant-col-xl-13">
                    <ul className="ippo_new_tab_list_new">
                      ...
                      <li><a className="inactive">Custom<span className="ant-calendar-picker"><span className="ant-calendar-picker-input ant-input"><input readOnly placeholder="Start date" className="ant-calendar-range-picker-input" tabIndex={-1} defaultValue /><span className="ant-calendar-range-picker-separator"> ~ </span><input readOnly placeholder="End date" className="ant-calendar-range-picker-input" tabIndex={-1} defaultValue /><i aria-label="icon: calendar" className="anticon anticon-calendar ant-calendar-picker-icon"><svg viewBox="64 64 896 896" focusable="false" className data-icon="calendar" width="1em" height="1em" fill="currentColor" >
