            ...
            <div className="container">
              ...
              <ul className="nav nav-tabs">
                <li className="nav-item">
                  <a
                    className={
                      "nav-link " + (tab === 1 ? "activepaylink" : "inactive")
                    }
                    onClick={() => SetTab(1)}
                  >
                    Payment Detail
                ...
                <li className="nav-item">
                  <a
                    className={
                      "nav-link " + (tab === 2 ? "activepaylink" : "inactive")
                    }
                    onClick={() => SetTab(2)}
                  >
                    Payment Link Detail
                ...
                <li className="nav-item">
                  <a
                    className={
                      "nav-link " + (tab === 3 ? "activepaylink" : "inactive")
                    }
                    onClick={() => SetTab(3)}
                  >
                    Import Bulk Payer
                ...
                <li className="nav-item">
                  <a
                    className={
                      "nav-link " + (tab === 4 ? "activepaylink" : "inactive")
                    }
                    onClick={() => SetTab(4)}
                  >
                    Reports
          ...
          >
            <div className="container-fluid">
              <div className="row">
                ...
                {(tab === 1 && <PayerDetails />) ||
                  (tab === 2 && <PaymentLinkDetail />) ||
                  (tab === 2 && <PaymentLinkDetail />) ||
                  (tab === 3 && <BulkPayer />) ||
                  (tab === 4 && <Reports />) || <PayerDetails />}
              </div>
            </div>
          </section>
        </div>
