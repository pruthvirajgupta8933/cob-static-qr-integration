...
function TransactionDetailModal({ fnSetModalToggle, transactionData }) {
  ...
  return (
    <div
      className={`${classes.customBackdrop} ${showModal ? classes.backdropShow : ''}`}
      onClick={handleClose}
    >
      <div
          ...
          {transactionData ? (
            <>
                ...
                <table className="table table-striped-columns table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <th>Amount</th>
                      <td>
                        {Number.parseFloat(transactionData.payee_amount).toFixed(2)}
                    ...
                    <tr>
                      ...
                      <td>{dateFormatBasic(transactionData.trans_complete_date)}</td>
                    </tr>
                    <tr>
                      <th>Bank Response</th>
              ...
              <div className="mb-5">
                ...
                <table className="table table-striped-columns table-bordered">
                  <tbody>
                    <tr><th>UDF1</th><td>{transactionData.udf1}</td></tr>
                    <tr><th>UDF2</th><td>{transactionData.udf2}</td></tr>
                    <tr><th>UDF3</th><td>{transactionData.udf3}</td></tr>
                    <tr><th>UDF4</th><td>{transactionData.udf4}</td></tr>
                    <tr><th>UDF5</th><td>{transactionData.udf5}</td></tr>
                    <tr><th>UDF6</th><td>{transactionData.udf6}</td></tr>
                    {udfToggle && (
                      <React.Fragment>
                        <tr><th>UDF7</th><td>{transactionData.udf7}</td></tr>
                        <tr><th>UDF8</th><td>{transactionData.udf8}</td></tr>
                        <tr><th>UDF9</th><td>{transactionData.udf9}</td></tr>
                        <tr><th>UDF10</th><td>{transactionData.udf10}</td></tr>
                        <tr><th>UDF11</th><td>{transactionData.udf11}</td></tr>
                        <tr><th>UDF12</th><td>{transactionData.udf12}</td></tr>
                        <tr><th>UDF13</th><td>{transactionData.udf13}</td></tr>
                        <tr><th>UDF14</th><td>{transactionData.udf14}</td></tr>
                        <tr><th>UDF15</th><td>{transactionData.udf15}</td></tr>
                        <tr><th>UDF16</th><td>{transactionData.udf16}</td></tr>
                        <tr><th>UDF17</th><td>{transactionData.udf17}</td></tr>
                        <tr><th>UDF18</th><td>{transactionData.udf18}</td></tr>
                        <tr><th>UDF19</th><td>{transactionData.udf19}</td></tr>
                        <tr><th>UDF20</th><td>{transactionData.udf20}</td></tr>
                      </React.Fragment>
                    )}
                    <tr
                    ...
                    >
                      <td colSpan={2}>
                        <p className="m-0 text-center font-bold">
                          {udfToggle ? "Hide UDF Values" : "Show UDF Values ..."}
                        </p>
                      </td>
                    </tr>
                  </tbody>
