...
function TransactionDetailModal({ fnSetModalToggle, transactionData }) {
  ...
  return (
    <div
      className={`modal fade mymodals show d-flex justify-content-end ${classes.z_index_99999}`}
        ...
        <div className="modal-content rounded-0">
          ...
          <div className="modal-body">
            <div className="mb-5">
              ...
              <table
                className={`table table-striped-columns table-bordered ${classes.table_layout_fixed}`}
              >
                <tbody>
                  <tr>
                    ...
                    <th>Amount</th>
                    <td>
                      {Number.parseFloat(transactionData.payee_amount).toFixed(
                        2
                      )}
                    </td>
                  </tr>
