...
function SideNavbar() {
  ...
  return (
    <aside className="gx-app-sidebar  gx-layout-sider-dark false- ant-layout-sider ant-layout-sider-dark">
        ...
        <ul>
          <li className="timeline">
            <Link to={`${url}`} className="txt-white">
              <i className="fa fa-home" aria-hidden="true" /> Home sfs
            </Link>
          </li>
          <li className="events">Events sfsd</li>
      ...
      <div className="ant-layout-sider-children" id="slide-menu">
        <div className="gx-sidebar-content">
          <div className="side_top_wrap">
            <span className="switch_live_label">Live</span>
            <div className="side_top_wrap_profile">
              <div className="side_top_wrap_toggle">
                <i className="fa fa-angle-down" />
              </div>
              <p
                title="ABHISHEK VERMA"
                className="text-md text-ellipsis text-capitalize ng-binding"
              >
              ...
              >
                ...
                >
                  <li
                    ...
                    role="menuitem"
                    style={{ paddingLeft: "24px", color: "white" }}
                  >
                  ...
                  <li
                    className="ant-menu-submenu ant-menu-submenu-inline ant-menu-submenu-open ant-menu-submenu-selected"
                    role="menuitem"
                  >
                    <div
                      className="ant-menu-submenu-title"
          ...
          <div className="sidebar-menu-query">
            {" "}
            <Link
              to={{ pathname: "https://sabpaisa.in/support-contact-us/" }}
              target="_blank"
            >
              <span className="sidebar-help-button">
                {" "}
