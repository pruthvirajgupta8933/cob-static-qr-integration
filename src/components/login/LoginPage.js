              ...
              <div className="logmod__wrapper">
                ...
                <div className="logmod__container">
                  <ul className="logmod__tabs">
                    <li data-tabtar="lgm-2" className="current"><a href="#" style={{width: '100%'}}>Login</a></li>
                      ...
                      <div className="logmod__form">
                        <form acceptCharset="utf-8" action="#" className="simform">
                          ...
                          <div className="simform__actions">
                            ...
                            <a href="./dashboard/payout.html" className="sumbit" name="commit" type="sumbit" value="Log In" style={{color: '#fff'}}>LogIn</a>
                            <span className="simform__actions-sidetext"><a className="special" role="link" href="#">Forgot your password? Click here</a></span>
                          </div> 
                        </form>
                      </div> 
                    </div>
