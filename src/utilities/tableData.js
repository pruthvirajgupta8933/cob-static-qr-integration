...
export const MandateReportData = [
  ...
  { id: "2", name: "Mandate Registration Id",selector:(row)=>row.mandateRegistrationId },
  ...
  { id: "6",name:"Mandate Purpose",selector:(row)=>row.mandatePurpose },
  { id: "7", name: "Payer Utility Code",selector:(row)=>row.payerUtilitityCode },
  { id: "8", name: "Payer Name",selector:(row)=>row.payerName},
  { id: "9", name: "Mandate End Date",selector:(row)=>row.mandateEndDate },
  { id: "10", name: "Mandate Max Amount",selector:(row)=>row.mandateMaxAmount},
  { id: "11", name: "Mandate Registration Time",selector:(row)=>row.mandateRegTime },
  { id: "12", name: "Mandate Type",selector:(row)=>row.mandateType },
  { id: "13", name: "Merchant Id",selector:(row)=>row.merchantId },
  { id: "14", name: "Mandate Start Date",selector:(row)=>row.mandateStartDate },
