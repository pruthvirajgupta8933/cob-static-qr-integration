...
import { transactionHistoryByUser } from '../../slices/subscription-slice/registrationHistorySlice';
const TransactionReport = () => {
    ...
    const handleViewSubmit = (values) => {
        ...
        let postDataS = {
            ...
            transaction_status: values.registration_status.toLowerCase() === "all" ? "" : values.registration_status,
