...
// const adminAPIURL = "https://stage-python-adminapi.sabpaisa.in/api";
// https://stage-python-adminapi.sabpaisa.in/api/rest/client_data/GenerateClientFormForCob/
...
const API_LIVE = {
  ...
  RATE_ENABLE_PAYLINK: adminAPIURL + "/common-data/31",
  ...
  GET_PAYMENT_STATUS_LIST: report_api_url + "/masters/paymentStatusMaster/",
  ...
  /* SabQR - Static QR Code APIs */
  QR_CREATE: `${url}/qr-codes/create`,
  QR_LIST: `${url}/qr-codes/list`,
  QR_DETAILS: `${url}/qr-codes/details`,
  QR_UPDATE: `${url}/qr-codes/update`,
  QR_DELETE: `${url}/qr-codes/delete`,
  QR_TOGGLE_STATUS: `${url}/qr-codes/toggle-status`,
  QR_GENERATE_IMAGE: `${url}/qr-codes/generate-image`,
  QR_VALIDATE_ID: `${url}/qr-codes/validate-identifier`,
  QR_BULK_CREATE: `${url}/qr-codes/bulk-create`,
  QR_BULK_TEMPLATE: `${url}/qr-codes/bulk-template`,
  QR_BULK_STATUS: `${url}/qr-codes/bulk-status`,
  QR_PAYMENTS_LIST: `${url}/qr-codes/payments`,
  QR_PAYMENTS_SUMMARY: `${url}/qr-codes/payments/summary`,
  QR_PAYMENTS_EXPORT: `${url}/qr-codes/payments/export`,
  QR_DASHBOARD_SUMMARY: `${url}/qr-codes/dashboard-summary`,
  QR_UPLOAD_LOGO: `${url}/qr-codes/upload-logo`,
  QR_DESIGN_TEMPLATES: `${url}/qr-codes/design-templates`,
  ...
  isClientCodeMapped: `${adminAPIURL}/common-data/4`,
  // https://stage-python-adminapi.sabpaisa.in/api/common-data/3/LPSD1/
  ...
  fetchParentClientCodes: `${adminAPIURL}/common-data/35/0`,
